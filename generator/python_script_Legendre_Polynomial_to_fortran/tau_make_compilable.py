...
file_input = "generated/TauPoly.f90"
file_output = "compilable/TauPoly.f90"

new_data = []

# add header
new_data = ["module TauPoly\n",
            "  implicit none\n",
            "\n",
            "  private\n",
            "  \n",
            "  public :: get_associated_legendre_polynomial_derivative\n",
            "\n",
            "  contains\n",
            "\n",
            ...
            "    end function\n",
            "\n",
            "    function get_associated_legendre_polynomial_derivative(l,m,x) result(erg)\n",
            "      implicit none\n",
            "      ! dummy\n",
            "      integer(kind=4) :: l\n",
            "      integer(kind=4) :: m\n",
...
# add footer
new_data.append("".join(["  end function get_associated_legendre_polynomial_derivative\n",
                         "end module\n"]))
