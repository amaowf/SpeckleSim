...
C    *S1,S2,Y,Z,ZB,ZETA1,ZETA1D,ZETA2,ZETA2D,ZN,ZR
     ...
     * ZET2DR, ZI, ZNI, ZNR, ZR, ZRI, ZRR, D1MACH, ZABS_amos
...
C-----------------------------------------------------------------------
        APHI = ZABS_amos(PHIR(J),PHII(J))
        AARG = ZABS_amos(ARGR(J),ARGI(J))
