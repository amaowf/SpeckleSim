! reference: https://people.sc.fsu.edu/~jburkardt/f_src/special_functions/special_functions.html
...
!
  ...
  do nr = 1, nt
    ...
    if ( kf == 2 ) then
      if ( nr == 2 ) then
        z = dcmplx ( 2.8334D+00, 0.2443D+00 )
      else if ( nr == 3 ) then
        z = dcmplx ( 3.4674D+00, 0.2185D+00 )
      else if ( nr == 4 ) then
        z = dcmplx ( 4.0025D+00, 0.2008D+00 )
      end if
    end if
